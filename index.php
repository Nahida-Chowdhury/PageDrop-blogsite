...
<body class="bg-slate-100 min-h-screen">
    ...
    <header class="bg-white shadow-sm border-b sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col lg:flex-row gap-4 lg:gap-0 items-center justify-between">
            ...
            <form method="GET"
                class="w-full lg:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3 relative">
                ...
                <div class="relative w-full sm:w-auto">
                    ...
                    <input type="text"
                        ...
                        class="border px-3 py-2 rounded-lg w-full sm:w-72 lg:w-64 pr-8">

                    <span
                        id="clearBtn"
                        class="hidden absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-gray-400 hover:text-red-500 text-lg">
                        ×
                    </span>
            ...
            fetch("?suggest=" + encodeURIComponent(this.value))
                ...
                .then(data => {
                    ...
                    data.forEach(item => {
                        ...
                        div.className =
                            "px-3 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-100 border-b last:border-b-0";
